######################################################################################################
# Script "DescuentoCompuesto.pl" - 14/04/2011 by EconomiaJoven.net                                   #
#                                                                                                    #
...
print "\n";
print "Este es un script PERL para DESCUENTO COMPUESTO.\n";
...
print "\n";
$capinicial = $capfin * ((1 - $descuento)**$periodos);
