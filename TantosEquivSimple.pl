######################################################################################################
# Script "TantosEquivSimple.pl" - 14/04/2011 by EconomiaJoven.net                                    #
#                                                                                                    #
...
print "\n";
print "Este es un script PERL para TANTOS DE INTERES Y DESCUENTO EQUIVALENTES EN CAPITALIZACION SIMPLE.\n";
...
if ($opcion == 1)
	...
	print "\n";
	$descuento = $interes / (1 + ($periodos * $interes));
	...
	print "\n";
	$interes = $descuento / (1 - ($periodos * $descuento));
